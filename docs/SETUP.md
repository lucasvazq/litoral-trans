...
3.3 Vamos a copiar unos archivos de una carpeta a la base del proyecto, por lo que primero hay que limpiarlo.
    Eliminamos las carpetas **_next** y **.sass-cache**, además de todas aquellas que se puedan crear desde la carpeta **src/public**.
    Lo mismo con los archivos. Tenemos que eliminar todos los archivos que se generen en base a las vistas definidas en **src/pages**.
    Además, tenemos que eliminar el archivo **404.html**.

3.4 Copiar los archivos de la carpeta **out** a la carpeta base del proyecto.
