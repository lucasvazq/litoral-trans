...
import { Route, Section } from ".."

const Paragraph = dynamic(() => import("../elements/Paragraph").then((mod) => mod.Paragraph))
    ...
    return (
      <>
        ...
        <div className="bg-secondary-dark text-center text-sm relative sm:static flex flex-col items-center p-6 z-1">
          ...
          <Paragraph>{`Diseñador por: `}<Route href="https://lucasvazq.github.io/" description="Lucas Vazquez" className="border-b border-secondary-light hover:text-primary italic"/></Paragraph>
        </div>
      </>
    )
  }
